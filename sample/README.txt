This sample application is modified from Roku's "videoplayer" sample application. The original is
available as one of the "videoplayer" template in their brightscript eclipse plugins, or available from:
